        ...
        <header>
            <nav className={`fixed flex w-full h-[64px] z-50 ${scrolling ? 'bg-secondary text-black' : 'bg-black'}`}>
                <div className="flex flex-wrap items-center md:p-0 justify-between w-full md:mx-12 border-b border-white">
                    ...
                    <div className={`${hamburgerOnClick ? '' : 'hidden'} md:block md:mr-12 ${scrolling ? 'text-black bg-secondary' : 'bg-black'} `}>
                        <ul className="items-center w-screen md:w-auto md:flex ">
                            <motion.li
                                className={`${activeSection === 'home' ? 'border-b-2 border-secondary' : 'hover:border-b-2'} ${scrolling ? 'text-black hover:border-black ' : 'text-white hover:border-secondary'}`}
                            ...
                            <motion.li
                                className={`${activeSection === 'pricing' ? 'border-b-2 border-black' : 'hover:border-b-2'} ${scrolling ? 'text-black hover:border-black ' : 'text-white hover:border-secondary'}`}
                                initial={{ y: -100, opacity: 0 }}
                                animate={{ y: 0, opacity: 1 }}>
                            ...
                            <motion.li className={`${activeSection === 'snacks' ? 'border-b-2 border-black' : 'hover:border-b-2'} ${scrolling ? 'text-black hover:border-black ' : 'text-white hover:border-secondary'}`}
                                initial={{ y: -100, opacity: 0 }}
                                animate={{ y: 0, opacity: 1 }}>
                            ...
                            <motion.li className={`${activeSection === 'events' ? 'border-b-2 border-black' : 'hover:border-b-2'} ${scrolling ? 'text-black hover:border-black ' : 'text-white hover:border-secondary'}`}
                                initial={{ y: -100, opacity: 0 }}
                                animate={{ y: 0, opacity: 1 }}>
